...
async function getResponse(req: NextRequest): Promise<NextResponse> {
  ...
  if (idAsNumber === 13) {
    ...
    <meta property="og:image" content="${process.env.NEXT_PUBLIC_GATEWAY_URL}/13.png" />
    <meta property="fc:frame" content="vNext" />
    <meta property="of:accepts:xmtp" content="2024-02-01" />
    <meta property="fc:frame:image" content="${process.env.NEXT_PUBLIC_GATEWAY_URL}/13.png" />
  ...
  return new NextResponse(
    ...
    <meta property="og:image" content="${process.env.NEXT_PUBLIC_GATEWAY_URL}/${id}.png" />
    <meta property="fc:frame" content="vNext" />
    <meta property="of:accepts:xmtp" content="2024-02-01" />

    <meta property="fc:frame:image" content="${process.env.NEXT_PUBLIC_GATEWAY_URL}/${id}.png" />
