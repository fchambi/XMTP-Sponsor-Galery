...
async function getResponse(req: NextRequest): Promise<NextResponse> {
  ...
  if (idAsNumber === 13) {
    ...
    <meta property="og:image" content="${process.env.NEXT_PUBLIC_GATEWAY_URL}/ipfs/QmcsCLmNGWEZU7Z9aHacZ5eHzGky5uQrTfojLYgRYrKw1B/1.png" />
    <meta property="fc:frame" content="vNext" />
    <meta property="of:accepts:xmtp" content="2024-02-01" />
    <meta property="fc:frame:image" content="${process.env.NEXT_PUBLIC_GATEWAY_URL}/ipfs/QmcsCLmNGWEZU7Z9aHacZ5eHzGky5uQrTfojLYgRYrKw1B/1.png" />
  ...
  return new NextResponse(
    ...
    <meta property="og:image" content="${process.env.NEXT_PUBLIC_GATEWAY_URL}/ipfs/QmcsCLmNGWEZU7Z9aHacZ5eHzGky5uQrTfojLYgRYrKw1B/${id}.png" />
    <meta property="fc:frame" content="vNext" />
    <meta property="of:accepts:xmtp" content="2024-02-01" />
